            ...
            <div class="container pb-2">
                    ...
                    <div class="card">
                        <div class="card-body site-status">
                            <div class="notificationContainer">
                                <p id="inonlinecount" class="notificationContent">
                                    Online: ...
                                </p>
                            ...
                            <div id="main1" class="d-flex flex-column justify-content-between h-100 autoheight"></div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body site-status">
                            <div class="notificationContainer">
                                <p id="armcount" class="notificationContent">
                                    ARM: ...
                                </p>
                            ...
                            <div id="main2" class="d-flex flex-column justify-content-between h-100 autoheight"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid-row grid-row-col-1 mt-2 mb-3 networdHelth">
                    <div class="card">
                        <div class="card-body site-status">
                            ...
                            <div id="main3" class="d-flex flex-column justify-content-between h-100"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid-row grid-row-col-1 mt-2 mb-3 networdHelth">
                    <div class="card">
                        <div class="card-body site-status">
                            <div class="notificationContainer">
                                <p id="nvronlinecount" class="notificationContent">
                                    Online: ...
                                </p>
                            ...
                            <div id="main4" class="d-flex flex-column justify-content-between h-100"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid-row grid-row-col-2 mt-2 mb-3">
                    <div class="card">
                        <div class="card-body site-status">
