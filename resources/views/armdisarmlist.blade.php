        ...
        <div class="pb-4 tabspage devicelist">
            <div class="container pb-2">
                <div class="row headerBar align-items-center">
                    <div class="col">
                        <h2 class="fw-bold">Alarm Panel Arm/Disarm</h2>
                    </div>
                </div>
            </div>
            ...
            <section>
                <nav>
                    <div class="nav nav-tabs px-3" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Arm</button>
                        <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Disarm</button>
                    </div>
                </nav>
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active px-3" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <ul id="armIn" class="notificationLists mb-0 mt-3">
                            <!-- <li>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <ul id="disarmIn" class="notificationLists mb-0 mt-3">
                        </ul>
                    </div>
                </div>
            </section>
